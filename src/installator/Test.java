...
public class Test extends javax.swing.JFrame {
    ...
    public Test() {
        initComponents();
        СhoiceStage stage = new СhoiceStage<Integer>("test", "TEST");
        JPanel jPanel1 = new СhoicePanel(stage, "test", "Выберите вариант установки", new String[] {"первый", "второй", "третий"});
